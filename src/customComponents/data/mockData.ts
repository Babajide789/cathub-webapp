...
export const mockCats: Cat[] = [
  {
    ...
    description: "Luna is a gentle and affectionate Persian cat who loves cuddles and quiet environments. She's perfect for apartment living and gets along well with children.",
...
export const mockProducts: Product[] = [
  {
    ...
    rating: 4.5,
    reviews: 124,
    description: "High-quality cat food made with real chicken and rice. Grain-free formula perfect for adult cats.",
    inStock: true
  },
  {
    id: "2",
...
export const mockPosts: Post[] = [
  {
    ...
    image: "https://images.unsplash.com/photo-1574158622682-e40e69881006?w=800",
    caption: "My Luna enjoying her favorite spot by the window ☀️ #catsofinstagram",
    likes: 234,
    comments: 18,
